...
function getSelectedModel() {
  return localStorage.getItem('rf_gemini_model') || 'gemini-1.5-flash';
}
  ...
  try {
    ...
    if (apiKey) {
      ...
      try {
        ...
        showNotification(`AI generation failed (${getSelectedModel() === 'gemini-1.5-pro' ? 'Gemini Pro' : 'Gemini Flash'}): ${aiErr.message}. Falling back to template mode README.`);
